...
public class CustomCursorAdapter extends RecyclerView.Adapter<CustomCursorAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(TaskViewHolder holder, int position) {
        ...
        int taskDescriptionIndex = mCursor.getColumnIndex(TaskContract.TaskEntry.COLUMN_DESCRIPTION);
        int priorityIndex = mCursor.getColumnIndex(TaskContract.TaskEntry.COLUMN_PRIORITY);
        int locationIndex  = mCursor.getColumnIndex(TaskContract.TaskEntry.COLUMN_LOCATION);
        int userNameIndex  = mCursor.getColumnIndex(TaskContract.TaskEntry.COLUMN_USERNAME);
        ...
        String [] userInfoArray = userName.split(",");
        String [] locationInfoArray = location.split(",");


        //Set values
        holder.itemView.setTag(id);
        holder.taskDescriptionView.setText(taskDescription );
        holder.location.setText(locationInfoArray[0]);
        holder.userName.setText(userInfoArray[0]);
